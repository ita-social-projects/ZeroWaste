    ...
    class DiaperCalculatorsController < ApplicationController
      def create
        ...
        values = [
          ...
          { name: 'money_will_be_spent', result: result.to_be_used_diapers_price || 0 },
          { name: 'used_diapers_amount', result: result.used_diapers_amount || 0 },
          { name: 'to_be_used_diapers_amount', result: result.to_be_used_diapers_amount || 0 }
        ]
