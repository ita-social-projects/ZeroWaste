class Calculators::PadUsageService
  attr_accessor :user_age, :menstruation_age, :menopause_age,
                ...
                :pads_per_cycle, :pad_category, :reusable_pad_price,
                :total_menstruations_amount, :total_disposable_products_amount,
  ...
  def calculate
    {
      ...
      already_used_products_cost: already_used_products * PAD_PRICES[pad_category],
      products_to_be_used:,
      products_to_be_used_cost: products_to_be_used * PAD_PRICES[pad_category]
    }
  end
