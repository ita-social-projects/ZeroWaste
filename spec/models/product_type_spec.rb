  ...
  describe 'validations' do
    it {
      is_expected.to validate_presence_of(:title)
        .with_message(I18n.t('activerecord.errors.models.product_type.attributes.title.blank'))
    }
    ...
    it {
      is_expected.not_to allow_value('.*+/+/').for(:title)
                                              .with_message(I18n.t('activerecord.errors.models.product_type.attributes.title.invalid'))
    }
  end
end
