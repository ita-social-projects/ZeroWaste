...
RSpec.describe Account::AppConfigsController, type: :request do
  ...
  describe "PATCH #update" do
    let(:diapers_calculator_params) do
      {
        "first_amount"=>"10", "first_price"=>"7.5",
        "second_amount"=>"8", "second_price"=>"9.5",
        "third_amount"=>"6", "third_price"=>"9",
        "fourth_amount"=>"6", "fourth_price"=>"10.5",
        "fifth_amount"=>"4", "fifth_price"=>"10.5",
        "sixth_amount"=>"4", "sixth_price"=>"12.5",
        "seventh_amount"=>"2", "seventh_price"=>"12.5"
      }
    end
