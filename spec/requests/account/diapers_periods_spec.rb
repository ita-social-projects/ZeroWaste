...
RSpec.describe Account::DiapersPeriodsController, type: :request do
  ...
  describe "GET #idex" do
    it "is successful" do
      ...
      get account_diapers_periods_path(format: :turbo_stream)
  ...
  describe "GET #new" do
    it "is successful" do
      allow(Category).to receive(:find).and_return(category)
      get new_account_diapers_period_path(format: :turbo_stream)
  ...
  describe "GET #edit" do
    it "is successful" do
      allow(Category).to receive(:find).and_return(category)
      get edit_account_diapers_period_path(diapers_period, format: :turbo_stream)
  ...
  describe "DELETE #destroy" do
    ...
    context "when destroy fails" do
      it "redirects to account_site_setting_path with alert message" do
        ...
        delete account_diapers_period_path(diapers_period, format: :turbo_stream), params: { id: diapers_period.id, category_id: category.id }
