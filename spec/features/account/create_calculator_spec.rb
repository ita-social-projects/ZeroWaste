...
describe "Create Calculator Page", js: true do
  ...
  context "when user clicks button Create calculator", skip: true do
  ...
  context "when user fill in the Name field with name that already exist" do
    it "shows message that name is already has been taken", skip: true do
  ...
  context "when user fill in the Name field with name shorter than 2 symbols" do
    it "shows message that name is too short", skip: true do
      fill_in "Name", with: "i"
      click_button CREATE_CALCULATOR_BUTTON
  ...
  context "when user fill in the Name field with symbols", skip: true do
  ...
  context "when user left the Name field blank", skip: true do
