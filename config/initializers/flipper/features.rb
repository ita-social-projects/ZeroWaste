...
Flipper[:old_calculator_design].en_description = "This feature flag is responsible for new calculator design"
Flipper[:old_calculator_design].uk_description = "Відкриває можливість використовувати новий дизайн калькулятора"
